...
def main():
    ...
    ap.add_argument(
        "--exclude", action="append", default=[], help="extra exclude glob (can be repeated)"
    )
    ...
    nodes, edges, clusters = scan_repo(
        root, excludes=excludes, follow_symlinks=args.follow_symlinks
    )
