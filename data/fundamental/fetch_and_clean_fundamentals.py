...
if __name__ == "__main__":
    ...
    fundamentals = {
        "cpi": {"series_id": "CPIAUCSL", "output_path": "data/fundamental/cleaned_cpi.csv"},
        "interest_diff": {
            "series_id": "IR",  # 仮の例
        ...
        "ffr": {"series_id": "FEDFUNDS", "output_path": "data/fundamental/cleaned_ffr.csv"},
        "gdp": {"series_id": "GDP", "output_path": "data/fundamental/cleaned_gdp.csv"},
    }
